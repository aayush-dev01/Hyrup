...
export default function BookingSuccessPage() {
  const teacherName = "Maya Krishnan";
        ...
        <SketchCard tilt={-1} className="p-12 max-w-lg bg-ink/[0.02]">
          <div className="flex justify-center mb-8">
            <div className="relative">
              <AvatarSVG seed={teacherName} size={80} />
              <motion.div
          ...
          <p className="text-ink-muted text-[16px] mt-4 leading-relaxed">
            You&apos;re all set! A calendar invite has been sent to your email. Maya is looking forward to seeing you.
          </p>
