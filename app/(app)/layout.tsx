/* Global app shell layout — fixed nav with scroll transition, mobile menu, active squiggle underlines. */
"use client";
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 z-10">
            {/* Notification bell */}
            <button className="relative p-1 text-ink hover:text-ink/70 transition-colors hidden md:block">
              ...
              {/* Unread indicator */}
              <span className="absolute top-0.5 right-0.5 w-2 h-2 bg-ink rounded-full" />
            </button>

            <UserButton
              appearance={{
                elements: {
                  userButtonAvatarBox: "w-8 h-8 border-2 border-ink/[0.15]",
                },
              }}
              afterSignOutUrl="/"
            />
